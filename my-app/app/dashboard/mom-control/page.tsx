               ...
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div className="flex items-center gap-3">
                     ...
                     <div>
                        ...
                        <p className="text-[9px] text-muted-foreground/40 font-bold uppercase tracking-[0.2em] mt-0.5">Step {currentStep} of 4 • {steps[currentStep-1].title}</p>
                     </div>
                  </div>
